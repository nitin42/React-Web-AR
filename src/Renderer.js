...
export default class Renderer extends React.Component {
	...
	static propTypes = {
		toolKitSource: PropTypes.objectOf({
		...
		toolKitContext: PropTypes.objectOf({
			...
			imageSmoothinEnabled: PropTypes.bool,
		}),
		toolKitMarkerControl: PropTypes.objectOf({
	...
	static defaultProps = {
		...
		toolKitContext: {
			...
			imageSmoothinEnabled: true, // Smoothen an image when scaling the canvas (default)
		},
